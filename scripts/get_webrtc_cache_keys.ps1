...
# In this repository the wrapper sources are the repo root itself.
$wrapperCommit = Get-GitObject -Repository $RootDir -Object "HEAD" -Git $GitExe
$outputInputHash = Get-OutputInputHash -LibWebrtcDir $RootDir -Git $GitExe
